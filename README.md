...
A production-style starter that extracts text from PDF business documents, sends it to Groq via a secure backend proxy, and renders concise business insights in a dark-themed React dashboard.
